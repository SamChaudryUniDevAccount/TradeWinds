                                   ...
                                   <div class="card-block">
                                       ...
                                       <form class="row">
                                           <div class="form-group">
                                               <input type="text" class="form-control inputData" name = "startDate" placeholder="Start Date" value="2017/02/2017">
                                           </div>
                                           <br/>
                                           <div class="form-group">
                                               <input type="text" class="form-control inputData" name ="endDate" placeholder="End Date" value="2017/02/2017">
                                           </div>
                                       </form>
                                   </div>
                                    <br/>
